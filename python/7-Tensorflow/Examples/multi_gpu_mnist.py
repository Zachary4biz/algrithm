...
##############
# 单机多GPU测试,代码来自: https://github.com/normanheckscher/mnist-multi-gpu/blob/master/mnist_multi_gpu_batching_train.py
##############
...
tf.app.flags.DEFINE_string('data_dir', '/home/zhoutong/MNIST_data',
                           """Path to the MNIST data directory.""")
tf.app.flags.DEFINE_string('train_dir', '/home/zhoutong/MNIST_train',
