...
# 由于app列表的特征问题,想用TensorFlow的稀疏tensor试一试
# 未完成
######
import numpy as np
...
class DeepFM(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            feat_index_sparse = tf.sparse_placeholder(tf.int32, name="feat_index")
            embeddings = tf.nn.embedding_lookup_sparse(w_feature_embeddings,feat_index_sparse)
             = tf.sparse_tensor_dense_matmul(feat_index_sparse, )
